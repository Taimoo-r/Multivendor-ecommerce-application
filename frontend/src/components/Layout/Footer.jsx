...
const Footer = () => {
  return (
    <div className="text-white bg-blue-500">
      ...
      <div className="grid bg-black grid-cols-1 sm:grid-cols-3 lg:grid-cols-4 gap-6 sm:px-8 px-5 py-16 sm:text-center">
        <ul className="px-5 text-center sm:text-start flex sm:block flex-col items-center">
          ...
          <div className="flex items-center mt-[15px]">
            ...
            <AiFillYoutube size={25} style={{ cursor: "pointer" }} />
          </div>
        </ul>
